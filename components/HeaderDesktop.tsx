...
const HeaderDesktop = () => {
  ...
  return (
    <div className="hidden lg:block">
      <header className="flex bg-[green] text-white-soft p-4 mx-auto lg:max-w-[1250px]  fixed md:relative md:flex md:justify-between md:items-center md:text-center">
